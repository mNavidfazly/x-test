...
|----|-------|-------|--------|--------------|
| EQW-01 | External Quiz Viewer Rendering | Learner | ✅ | 2026-02-17 |
| EQW-02 | Manual Mark Complete (Fallback) | Learner | ✅ | 2026-02-17 |
| EQW-03 | Webhook Auto-Marks Progress on Pass | Learner + API | ✅ | 2026-02-17 |
| EQW-04 | Webhook Fail Does NOT Auto-Mark | Learner + API | ✅ | 2026-02-17 |
| EQW-05 | Webhook API Key Validation | API only | ✅ | 2026-02-17 |
| EQW-06 | Progress Visible After Webhook (Course Detail) | Learner + Admin | ✅ | 2026-02-17 |
...
| 2026-02-17 | Claude Opus 4.6 (Playwright MCP) | EQW-01 through EQW-06 (full regression) | 6 | 0 | Full re-test of all stories. All stories pass. No bugs found. |
